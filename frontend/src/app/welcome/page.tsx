...
export default function WelcomePage() {
    ...
    const handleGuestAccess = () => {
        try {
            ...
            toast({
                title: "Welcome, Guest!",
                description: "You are exploring the app as a guest. Your data will be stored locally.",
            });
            router.push('/');
        } catch (error) {
        ...
        <div className="flex flex-col min-h-screen bg-background">
            ...
            <main className="flex-grow flex flex-col items-center justify-center text-center p-6">
                ...
                >
                    ...
                    <p className="text-lg text-muted-foreground">
                        Take control of your finances. Track your spending, save money, and achieve your goals with CoinWise.
                    </p>
                </motion.div>
            </main>
            <motion.footer
            ...
            >
                <div className="flex flex-col sm:flex-row gap-4">
                 ...
                 <div className="mt-4">
                    <Button onClick={handleGuestAccess} variant="link" className="w-full text-muted-foreground">
